...
/bin/yum install autoconf automake libtool pkgconfig perl-ExtUtils-MakeMaker gcc openssl-devel pcre-devel ncurses-devel libcurl-devel libcap-devel hwloc-devel flex git
